...
include_once 'export-excel-function.php';
...
require get_template_directory() .'/../all_functions.php';

require get_template_directory() .'/aq_resizer.php';

require get_template_directory() .'/wpd-functions.php';


remove_action( 'register_form', 'baweic_register_form_add_field' );
remove_filter( 'registration_errors', 'baweic_registration_errors', 20, 3 ); 
remove_action( 'login_footer', 'baweic_login_footer' );
