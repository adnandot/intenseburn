...
<section class="memberarea"><div class="wrapper">		
		...
		<div style="margin-bottom:10px;" class="memberarea-pole">
			...
			<form name="loginform" id="loginform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'lostpassword' ); ?>" method="post">
			...
			<div class="loginlostpass"><?php $template->the_action_links( array( 'lostpassword' => false ) ); ?></div>
		</div>
	</div>
</section>
