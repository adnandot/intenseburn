                      ...
                      <div class="meal-plan-week">
                        <div id="image-png" class="right-meal-plan">
                          <div class="meal-plan-top-names">
                           ...
                           <tbody>
                           <tr>
                           <th width="14.2%"><div style="background:#fff !important;" class="meal-plan-top-single-name"> </div></th>
                           <th width="14.2%"><div style="border-left:none;" class="meal-plan-top-single-name"> Breakfast </div></th>
                           <th width="14.2%"><div class="meal-plan-top-single-name"> Snack </div></th>
                           <th width="14.2%"><div class="meal-plan-top-single-name"> Lunch </div></th>
                           <th width="14.2%"><div class="meal-plan-top-single-name"> Snack </div></th>
                           <th width="14.2%"><div class="meal-plan-top-single-name"> Dinner </div></th>
                           <th width="14.2%"><div class="meal-plan-top-single-name"> Post Workout </div></th>
                           </tr>
                          ...
                          <div class="meal-plan-information" id="<?php echo $day?>_wrappper" style="position:relative;">
                          <table width="100%" cellpadding="0" cellspacing="0">
                           <tbody>
                           <tr>
                           <td width="14.2%" bgcolor="#f85f01">
                            
                            <div class="meal-plan-day" style="background-color:#f85f01">
